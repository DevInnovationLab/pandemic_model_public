function event_list_simulation(simulation_table, econ_loss_model, params)
    ...
    adv_cap_m = [zeros([1, build_years]), repmat(params.z_m, 1, non_build_years)]; % 1 x Y
    adv_cap_o = [zeros([1, build_years]), repmat(params.z_o, 1, non_build_years)]; % 1 x Y
    ...
    adv_cap_m_annual_cap_cost = adv_cap_m .* params.k_a;
    adv_cap_o_annual_cap_cost = adv_cap_o .* params.k_a;
    adv_cap_annual_cap_cost = adv_cap_m_annual_cap_cost + adv_cap_o_annual_cap_cost;

    surge_cap_annual_cap_cost = surge_cap_m_cost + surge_cap_o_cost;

    %% COST CALCULATIONS
    adv_cap_annual_cap_cost_pv = adv_cap_annual_cap_cost .* pv_factors_annual;
    surge_cap_annual_cap_cost_pv = surge_cap_annual_cap_cost .* pv_factors_annual;
    ...
    result_cols = {'cap_avail_m', 'cap_avail_o', 'u_deaths', 'm_deaths', 'vax_benefits', ...
                   ...
                   'vax_fraction_end', 'inp_marg_costs_PV', 'inp_RD_costs_PV', ...
                   'inp_cap_costs_PV'};
    ...
    sim_results.inp_cap_costs_PV(event_sim_idx) = surge_cap_annual_cap_cost_pv(event_start_idx);

    % Save results if requested
    if params.save_output
        save_to_file(params.scenario_name, params.rawoutpath, sim_results, ...
            adv_cap_annual_cap_cost_nom, adv_cap_annual_cap_cost_pv, ...
            ...
            surge_cap_annual_cap_cost_nom, surge_cap_annual_cap_cost_pv, ...
