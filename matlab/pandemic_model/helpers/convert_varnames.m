function converted_names = convert_varnames(varnames)
    ...
    converter = dictionary( ...
        ["adv_cap", "prototype_RD", "benefits", "inp_cap", "inp_marg", "inp_RD", "inp_tail", ...
         ...
         "advance_capacity", "advance_rd", "neglected_vf_rd", "enhanced_surveillance", "combined_invest", "baseline", "ufv_RD", ...
         "universal_flu_rd"], ...
        ["Advance capacity", "Advance R&D", "Benefits (present value)", "Response capacity", "Vaccination unit costs", ...
         ...
         "Advance capacity", "Neglected disease R&D", "Neglected disease R&D", "Enhanced surveillance", "Combined", "Baseline", "Universal flu vaccine R&D", ...
