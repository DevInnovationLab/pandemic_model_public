function save_to_file(scenario_name, outdirpath, sim_results, ...
    ...
    out_arr_name = sprintf('%s/%s_ts_%s.csv', outdirpath, scenario_name, 'prototype_RD_n');
    writematrix(sim_out_arr_costs_prototype_RD_nom, out_arr_name, 'Delimiter','comma', 'WriteMode', 'overwrite');
    out_arr_name = sprintf('%s/%s_ts_%s.csv', outdirpath, scenario_name, 'prototype_RD_p');
    writematrix(sim_out_arr_costs_prototype_RD_PV, out_arr_name, 'Delimiter','comma', 'WriteMode', 'overwrite');
