function new_simulation_table = get_scenario_simulation_table(base_simulation_table, ptrs_pathogen, ...
	...
	%                           improved_early_warning (active only), improved_ew_precision,
	%                           improved_ew_recall, base_ew_precision, base_ew_recall,
	%                           months_to_early_detect, months_to_regular_detect,
	%                           initial_share_ufv, highest_false_positive_rate,
	...
	if params.improved_early_warning.active
		scenario_false_positive_rate = 1 - params.improved_ew_precision;
	else
		scenario_false_positive_rate = 0;
	end
	false_keep_rate = (...
    ...
    if params.improved_early_warning.active
        ew_recall_op = params.improved_ew_recall;
    else
        ew_recall_op = params.base_ew_recall;
    end
	...
	new_simulation_table.rd_state(is_false) = nan;
