function plot_net_value_boxplot(out_dir)
    ...
    all_scenarios = all_scenarios(~strcmp(all_scenarios, 'status_quo'));
    ...
    status_quo_file = fullfile(processed_dir, 'status_quo_annual_sums.mat');
    S_base = load(status_quo_file, 'all_status_quo_sums');
    baseline_tbl = S_base.all_status_quo_sums;
    ...
    baseline_table = table("status_quo", "Status quo response", mean_base, med_b, ...
        perc_10_90_b(1), perc_15_b, perc_20_b, q1_b, q3_b, perc_10_90_b(2), 'VariableNames', moment_names);
    writetable(baseline_table, fullfile(processed_dir, "net_value_boxplot_moments_status_quo.csv"));
