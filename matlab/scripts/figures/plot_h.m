...
text(0.02, 0.05, '(0, 0)', 'FontSize', spec.typography.legend, ...
...
text(0.12, h_function(0.11) - 0.03, sprintf('(%.2f, %.2f)', 0.11, h_function(0.11)), ...
    'FontSize', spec.typography.legend, 'FontName', spec.font_name, 'HorizontalAlignment', 'left')
text(0.41, h_function(0.40) - 0.03, sprintf('(%.2f, %.2f)', 0.40, h_function(0.40)), ...
    'FontSize', spec.typography.legend, 'FontName', spec.font_name, 'HorizontalAlignment', 'left')
text(0.71, 0.98, '(0.70, 1)', 'FontSize', spec.typography.legend, 'FontName', spec.font_name, ...
