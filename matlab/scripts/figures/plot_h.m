...
text(0.12, vax_mitigation_factor(0.11) - 0.03, sprintf('(%.2f, %.2f)', 0.11, vax_mitigation_factor(0.11)), ...
    'FontSize', 11, 'FontName', 'Arial', 'HorizontalAlignment', 'left')
text(0.41, vax_mitigation_factor(0.40) - 0.03, sprintf('(%.2f, %.2f)', 0.40, vax_mitigation_factor(0.40)), ...
    'FontSize', 11, 'FontName', 'Arial', 'HorizontalAlignment', 'left')
