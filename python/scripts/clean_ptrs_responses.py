"""Clean vaccine probability of technical success (PTRS) survey responses.

Reads raw PTRS elicitations from the CEPI expert survey Excel file, reshapes from
wide to long format, parses range strings into (min, max) numeric bounds, and maps
...
Run from the repository root:
    python scripts/clean_ptrs_responses.py
"""
...
if __name__ == "__main__":
  ...
  # --- Merge adv R&D prototype status ---
