"""Clean vaccine R&D timeline and cost survey responses.

Reads raw vaccine speedup and cost elicitations from the CEPI expert survey Excel
file, reshapes from wide to long format, converts time ranges to years, converts
cost ranges to millions USD, and maps diseases to pathogen groups.

Inputs:  CEPI Expert Survey Excel file (Box path — see hardcoded path below)
Outputs: data/clean/vaccine_rd_timeline_responses.csv
         data/clean/vaccine_rd_cost_responses.csv

Run from the repository root:
    python scripts/clean_rd_timeline_and_cost_responses.py
"""
import pandas as pd
...
if __name__ == "__main__":
    ...
    # --- Load and clean speedup and cost data ---
