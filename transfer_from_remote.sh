...
# baseline_vaccine_program raw: default/ + ptrs_pathogen_gamma1 baselines/<slug>/ for
#   plot_baseline_program_exceedances (slug is status_quo_slug in sensitivity_chunk_manifest.mat)
DEFAULT_PATHS=(
  ...
  "output/single_runs/allrisk_base/figures"
  ...
  # Sensitivity (program-scoped: one folder per program under the run name)
  "output/sensitivity_runs/baseline_vaccine_program/program_sensitivity_config.yaml"
  "output/sensitivity_runs/baseline_vaccine_program/sensitivity_chunk_manifest.mat"
  "output/sensitivity_runs/baseline_vaccine_program/vaccine_program/processed"
  "output/sensitivity_runs/baseline_vaccine_program/vaccine_program/sensitivity_config.yaml"
  "output/sensitivity_runs/baseline_vaccine_program/vaccine_program/default/raw"
  "output/sensitivity_runs/baseline_vaccine_program/vaccine_program/default/run_config.yaml"
  "output/sensitivity_runs/baseline_vaccine_program/vaccine_program/baselines/3e1857c920555c43/raw" 
  "output/sensitivity_runs/baseline_vaccine_program/vaccine_program/baselines/3e1857c920555c43/baseline_run_config.yaml"
  "output/sensitivity_runs/advance_investment_programs/program_sensitivity_config.yaml"
  "output/sensitivity_runs/advance_investment_programs/sensitivity_chunk_manifest.mat"
  "output/sensitivity_runs/advance_investment_programs/advance_capacity/processed"
  "output/sensitivity_runs/advance_investment_programs/advance_capacity/sensitivity_config.yaml"
  "output/sensitivity_runs/advance_investment_programs/improved_early_warning/processed"
  "output/sensitivity_runs/advance_investment_programs/improved_early_warning/sensitivity_config.yaml"
  "output/sensitivity_runs/advance_investment_programs/prototype_rd/processed"
  "output/sensitivity_runs/advance_investment_programs/prototype_rd/sensitivity_config.yaml"
  "output/sensitivity_runs/advance_investment_programs/universal_flu_vaccine/processed"
  "output/sensitivity_runs/advance_investment_programs/universal_flu_vaccine/sensitivity_config.yaml"
)
