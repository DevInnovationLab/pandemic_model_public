function out = calc_adv_capacity_costs(params, yr_start, prep_start_month, nom_cost, pv, capacity_kept)
	...
	cap_costs_arr(yr_start+1:end) = params.delta * nom_cost * capacity_kept;% * (1-rental_fraction); % subsequent years, incur depreciation minus rental income on fraction kept if not adv
