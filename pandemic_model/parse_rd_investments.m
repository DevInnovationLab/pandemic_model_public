function adv_RD_families = parse_rd_investments(rd_investment_config, vf_data)
    ...
    baseline_RD_families = vf_data.viral_family(vf_data.has_adv_RD == true) % Check that 1s evaluate to true
    vfd_no_adv_RD = vf_data(~vf_data.has_adv_RD, :);  % Get viral families that don't already have advanced R&D
    ...
    if strcmp(rd_strategy, "top")
        ...
        adv_RD_families = [baseline_RD_families; new_invested_families] % Check these are column vectors
