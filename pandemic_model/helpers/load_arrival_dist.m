function arrival_dist = load_arrival_dist(arrival_dist_config_path)
    ...
    if strcmpi(file_ext, '.yaml')
        ...
        arrival_dist = ParametrizedArrivalDist(arrival_dist_config.dist_family, ...
                                               ...
                                               arrival_dist_config.dist_params);
    elseif strcmpi(file_ext, '.csv')
        ...
        arrival_dist = EmpiricalArrivalDist(severity_values, exceed_probs); % Add custom interpolation method later.
