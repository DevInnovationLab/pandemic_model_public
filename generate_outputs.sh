...
#     and baseline_vaccine_program and advance_investment_programs sensitivities.
#     For baseline_vaccine exceedance figures, transfer must include vaccine_program/default/raw
#     and baselines/<ptrs_slug>/raw (see transfer_from_remote.sh).
#
...
DIR_NO_MIT="${DIR_NO_MIT:-output/sensitivity_runs/no_mitigation_all/no_mitigation}"
DIR_NO_MIT_BASELINE="${DIR_NO_MIT_BASELINE:-${DIR_NO_MIT}/default}"
DIR_BASELINE_VACCINE_SENS="${DIR_BASELINE_VACCINE_SENS:-output/sensitivity_runs/baseline_vaccine_program/vaccine_program}"
DIR_ADVANCE_INVESTMENT_SENS="${DIR_ADVANCE_INVESTMENT_SENS:-output/sensitivity_runs/advance_investment_programs}"
...
require_dir "${DIR_ADVANCE_INVESTMENT_SENS}"
...
matlab -batch "run('./matlab/load_project.m'); 
               ...
               write_adv_invest_sensitivity_table('${DIR_ADVANCE_INVESTMENT_SENS}');
               write_advance_invest_sensitivity_figures('${DIR_ADVANCE_INVESTMENT_SENS}');
               ...
               plot_baseline_program_exceedances('both');"
