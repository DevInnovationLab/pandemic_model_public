...
for s = 1:sim_cnt
    ...
    ind = i_arr > params.i_star; % indicator array for whether the intensity in each period exceeds some threshold
...
sim_scens = table(yr_start_arr, intensity_arr, state_arr, natural_dur_arr);
...
if save_output == 1
	delete('sim_scens.xlsx');
    writetable(sim_scens, 'sim_scens.xlsx','Sheet',1);
end
