...
// Run regressions
eststo pathogen_model: intreg value_min value_max i.pathogen_enc i.platform_enc, vce(cluster respondent)
...
preserve
    ...
    twoway (scatter preds pathogen_enc, msize(0)) ///
    ...
    graph export "./output/ptrs/pathogen_model_preds.png", replace width(2400)
